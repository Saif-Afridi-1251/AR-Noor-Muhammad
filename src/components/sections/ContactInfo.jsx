  ...
  return (
    <section id="contact-info" className="max-w-7xl mx-auto px-6 py-16">
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-3xl border border-slate-700 bg-slate-950/90 p-8 text-white shadow-xl">
          <div className="flex items-start gap-4">
            <div className="rounded-2xl bg-blue-600/20 p-4 text-blue-300">
              <FaPhone size={24} />
            </div>
            <div>
        ...
        <div className="rounded-3xl border border-slate-700 bg-slate-950/90 p-8 text-white shadow-xl">
          <div className="flex items-start gap-4">
            <div className="rounded-2xl bg-cyan-500/20 p-4 text-cyan-300">
              <FaEnvelope size={24} />
            </div>
            <div>
              <p className="text-sm uppercase tracking-[2px] text-slate-400">
